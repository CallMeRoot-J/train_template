...
class ValueHead(nn.Module):
    ...
    def __init__(self, n_features=384, board_size=19):
        ...
        self.board_size = board_size
        self.fc = nn.Sequential(
            nn.Linear(n_features, 128), nn.ReLU(), nn.Linear(128, 1), nn.Tanh()
        )
...
class ConvNeXtV2(nn.Module):
    ...
    def __init__(
        ...
        self.policy_head = PolicyHead(
            n_features=dims[-1], board_size=board_size)
...
def convnextv2_femto(in_chans=4, board_size=19):
    model = ConvNeXtV2(
        in_chans=in_chans,
...
def chess_convnextv2_atto(in_chans=4, board_size=19):
    model = ConvNeXtV2(
        in_chans=in_chans,
        board_size=board_size,
        depths=[2, 2, 6, 2],
...
def chess_convnextv2_2262(in_chans=3, board_size=19):
    model = ConvNeXtV2(
        in_chans=in_chans,
        board_size=board_size,
        depths=[2, 2, 6, 2],
...
def chess_convnextv2_2242(in_chans=4, board_size=19):
    model = ConvNeXtV2(
        in_chans=in_chans,
        board_size=board_size,
        depths=[2, 2, 4, 2],
...
def chess_convnextv2_1121(in_chans=4, board_size=19):
    model = ConvNeXtV2(
        in_chans=in_chans,
        board_size=board_size,
        depths=[1, 1, 2, 1],
...
if __name__ == "__main__":
    ...
    model = chess_convnextv2_2242(in_chans=4, board_size=19)
